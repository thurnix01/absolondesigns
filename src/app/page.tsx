      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-[var(--header-bg)] border-b border-[var(--card-border)]">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6">
            <Link href="#home" className="text-[var(--text-primary)] hover:text-[var(--primary)]">Home</Link>
            <Link href="#about" className="text-[var(--text-primary)] hover:text-[var(--primary)]">About</Link>
            <Link href="#projects" className="text-[var(--text-primary)] hover:text-[var(--primary)]">Projects</Link>
            <Link href="#contact" className="text-[var(--text-primary)] hover:text-[var(--primary)]">Contact</Link>
          </nav>
            ...
            <div className="max-w-3xl mx-auto md:mx-0">
              <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
                <div className="relative w-48 h-48 rounded-full overflow-hidden border-4 border-[var(--card-border)] shadow-lg">
                  <Image
                    src="/absolondesigns/profile.png"
                    alt="Profile Picture"
                    fill
                    unoptimized
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="flex gap-4 justify-center md:justify-start">
                    <a href="mailto:contact@example.com" className="px-4 py-2 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded-md flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      Email Me
                    </a>
                    <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-[var(--card-border)] hover:bg-[var(--input-bg)] rounded-md flex items-center gap-2">
        ...
        <section id="projects" className="py-20 container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <AnimatedSection delay={100} className="h-full">
              <div className="group bg-[var(--card-bg)] rounded-lg overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-2 h-full border border-[var(--card-border)]">
          ...
          <AnimatedSection delay={400}>
            <div className="text-center mt-12">
              <a href="#" className="inline-block px-6 py-3 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded-md">
                View all projects
              </a>
            </div>
          </AnimatedSection>
            ...
            <AnimatedSection delay={100}>
              <div className="max-w-3xl mx-auto bg-[var(--card-bg)] p-8 rounded-lg shadow-md border border-[var(--card-border)]">
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input 
                        type="text" 
                        id="name" 
                        className="w-full px-4 py-2 border border-[var(--input-border)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary)] bg-[var(--input-bg)]" 
                  ...
                  <button 
                    type="submit" 
                    className="w-full md:w-auto px-6 py-3 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded-md"
                  >
                    Send Message
                  </button>
                </form>
